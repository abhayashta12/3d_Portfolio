    ...
    <motion.div variants={fadeIn("up", "spring", index * 0.5, 0.75)}>
     <Tilt options={{
      ...
      speed:450
          ...
          className="ng-tertiary p-5 rounded-2x1
          sm:w-[360px] w-full">
...
const Works = () => {
  ...
  <motion.div variants={textVariant()}>
    ...
    <div className="w-full flex">
      ...
      [17px] max-w-3x1 leading-[30px]"
      >
        Following projects showcase my skills and experience through 
        real-world examples of my work. Each project is 
        briefly described with links to code repositories and 
        live demos in it. It reflects my abilitiy to solve complex
         problems, work with diffrent technologies,
         and manage projects effeciently. 
      </motion.p>
    </div>
